...
logo = Image.open(
    'https://github.com/nvamsimohan/streamlit/blob/main/DDSA%20White1.jpg')
...
st.markdown('<p class="font">Import your data and generate a Pandas data profiling report easily...</p>',
